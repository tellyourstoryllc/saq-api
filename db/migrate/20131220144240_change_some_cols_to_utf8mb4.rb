class ChangeSomeColsToUtf8mb4 < ActiveRecord::Migration
  def up
    ...
    execute 'ALTER TABLE rpush_notifications MODIFY alert VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL'
  ...
  def down
    ...
    execute 'ALTER TABLE rpush_notifications MODIFY alert VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL'
