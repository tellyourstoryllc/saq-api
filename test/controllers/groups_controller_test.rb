  ...
  describe "POST /groups" do
    ...
    describe "valid" do
      it "must create a group" do
        ...
        group = Group.last
        result.must_equal [{'object_type' => 'group', 'id' => group.id, 'name' => 'Cool Dudes', 'join_url' => "http://test.host/join/#{group.join_code}", 'admin_ids' => [current_user.id], 'member_ids' => [current_user.id]}]
      end
    end
  end
end
