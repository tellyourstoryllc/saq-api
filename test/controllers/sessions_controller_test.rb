...
describe SessionsController do
  describe "POST /login" do
    ...
    it "must log in account when email and password are correct" do
      ...
      result_must_include 'user', user.id, {'object_type' => 'user', 'id' => user.id, 'name' => user.name, 'username' => user.username,
        'token' => user.token, 'status' => 'unavailable', 'idle_duration' => nil, 'status_text' => nil, 'client_type' => nil, 'avatar_url' => nil}
