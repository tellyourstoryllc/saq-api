...
class PublicFeedTest < ActiveSupport::TestCase
  describe "PublicFeed#feed_api" do
    ...
    it "must not return deactivated or unregistered users" do
      ...
      results = PublicFeed.feed_api(current_user, {})
    ...
    it "must order by newest" do
      ...
      results = PublicFeed.feed_api(current_user, sort: 'newest')
    ...
    it "must order by newest with radius" do
      ...
      results = PublicFeed.feed_api(current_user, sort: 'newest', radius: 25)
    ...
    it "must order by nearest" do
      ...
      results = PublicFeed.feed_api(current_user, sort: 'nearest', latitude: 39.9475787, longitude: -75.1564073)
    ...
    it "must order by nearest with explicit radius" do
      ...
      results = PublicFeed.feed_api(current_user, sort: 'nearest', latitude: 39.9475787, longitude: -75.1564073, radius: 25)
