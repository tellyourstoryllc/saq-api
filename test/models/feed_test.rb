...
describe Feed do
  describe "#feed_api" do
    ...
    it "must return the first page of feed users" do
      ...
      deactivated_user = FactoryGirl.create(:registered_user, :deactivated)

      results = Feed.feed_api(current_user, {})
      results.must_be :present?
      u = results[0]
      u.must_equal current_user
      results.wont_include deactivated_user
    end

    it "must order by newest" do
      user1 = current_user = FactoryGirl.create(:registered_user, created_at: 2.minutes.ago)
      user2 = FactoryGirl.create(:registered_user, created_at: 1.minute.ago)
    ...
    it "must order by newest with radius" do
      user1 = current_user = FactoryGirl.create(:registered_user, created_at: 2.minutes.ago, latitude: 39.9475787, longitude: -75.1564073)
      user2 = FactoryGirl.create(:registered_user, created_at: 1.minute.ago, latitude: 39.7, longitude: -75.2)
      FactoryGirl.create(:registered_user, latitude: 40.0, longitude: -76.0)
    ...
    it "must order by nearest" do
      current_user = FactoryGirl.create(:registered_user, latitude: 39.9475787, longitude: -75.1564073)
      nearby_user = FactoryGirl.create(:registered_user, latitude: 39.7, longitude: -75.2)
      FactoryGirl.create(:registered_user, latitude: 40.0, longitude: -76.0)
    ...
    it "must order by nearest with explicit radius" do
      current_user = FactoryGirl.create(:registered_user, latitude: 39.9475787, longitude: -75.1564073)
      nearby_user = FactoryGirl.create(:registered_user, latitude: 39.7, longitude: -75.2)
      FactoryGirl.create(:registered_user, latitude: 45.0, longitude: -78.0)
